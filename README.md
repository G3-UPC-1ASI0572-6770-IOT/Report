...
La sección 4.1.3 completa se movió a un archivo dedicado para mantener el README dentro del límite de render de GitHub.

- Versión completa: [4.1.3 Software Architecture](./docs/4.1.3-software-architecture.md)

## 4.2. Tactical-Level Domain-Driven Design

La sección 4.2 completa se movió a un archivo dedicado porque GitHub recorta READMEs grandes en la vista principal.

- Versión completa: [4.2 Tactical-Level Domain-Driven Design](./docs/4.2-tactical-level-domain-driven-design.md)
- Incluye todas las imágenes y diagramas referenciados en `./assets/`.
