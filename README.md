...
| 5.0.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Actualización integral del informe para **TB1 / Semana 7**, incorporando el **Capítulo V: Solution UI/UX Design** con Style Guidelines, Information Architecture, Landing Page y Applications UX/UI Design, Prototyping e IoT Device Design. Incluye el **Capítulo VI: Product Implementation, Validation & Deployment** con Software Configuration Management, Source Code Management, Software Deployment Configuration y **Sprint 1** completo. |
| 5.1.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Desarrollo del **Sprint 1**: Sprint Planning 1, Aspect Leaders and Collaborators, Sprint Backlog 1, Development Evidence, Testing Suite Evidence, Execution Evidence, Services Documentation Evidence, Software Deployment Evidence y Team Collaboration Insights. |
| 5.2.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Actualización integral del informe para **AV2 / Semana 12**, incorporando el **Sprint 2** completo, **Validation Interviews** con 6 entrevistas (3 conductores + 3 administradores), **Evaluaciones según heurísticas** (10 heurísticas de Nielsen), **Video About-the-Product** y actualización de **Conclusiones y recomendaciones**. |
| 5.3.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Documentación de la **Testing Suite Evidence para Sprint 2** verificada contra el repositorio real (`back/`). Incluye plan de testing para Sprint 3 con unit tests, integration tests y acceptance tests BDD con Gherkin. |
| 5.4.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Documentación del **Registro de Entrevistas de Validación** con 6 fichas completas (datos demográficos, capturas, timings, resúmenes analíticos) y de las **Evaluaciones Heurísticas** con 10 problemas identificados, severidad y recomendaciones (formato Anexo D). |
| 5.5.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Documentación del **Video About-the-Product** (2:30 min) con pauta de 7 secuencias, timings, URLs Microsoft Stream/YouTube y resumen narrativo. Actualización de **Software Deployment Evidence** con 7 productos desplegados (Landing, Web, Core API, Edge, Mobile, Supabase, Embedded). |
| 5.6.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Documentación de **Services Documentation Evidence** con 36 endpoints verificados contra código real (`back/`), incluyendo rutas exactas, DTOs, autenticación y 5 rutas Edge API con circuit breaker y resiliencia offline. |
| 5.7.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Actualización de **Team Collaboration Insights** con métricas de contribución por repositorio durante Sprint 2, **Execution Evidence** con 16 vistas Web reales + 8 pantallas Mobile, y **Evidencias de Colaboración GitHub** AV2. |
| 5.8.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Incorporación de **Mejoras identificadas en revisión de código** (15 hallazgos) y actualización de **Conclusiones y recomendaciones** con resultados de validación contrastados contra Hypothesis Statements del Capítulo I. |
| 5.9.0     | 16/06/2026 | Soto Quispe, Diego Ulises        | Consolidación final del informe para **AV2 / Semana 12**, integrando todas las evidencias de Sprint 2, entrevistas de validación, evaluación heurística, video About-the-Product y Anexos con Videos de Exposiciones (AV1, TB1, AV2). |
...
Durante la entrega **AV1**, el equipo construyó la base académica y documental del proyecto en formato Markdown, consolidando los **Capítulos I, II, III y IV** del informe. En esta etapa se priorizó la trazabilidad entre problema, segmentos objetivo, entrevistas, needfinding, backlog, domain-driven design y arquitectura de software. La coordinación del trabajo se realizó mediante sesiones síncronas de revisión y trabajo asíncrono sobre el repositorio del informe, manteniendo un esquema de revisión cruzada por secciones.

En esta entrega, Soto Quispe, Diego Ulises lideró la consolidación del documento principal, mientras que los demás integrantes participaron en la revisión de consistencia técnica, estructura, ortografía, nomenclatura de figuras y validación de artefactos de dominio y arquitectura. La actividad colaborativa se centró en asegurar que el informe no fuera una suma aislada de secciones, sino una narrativa coherente entre análisis del problema, requisitos y diseño de solución.

**Evidencia de colaboración AV1**

![Colaboración GitHub AV1](assets/reportedecolaboracion.jpeg)

### Entrega TB1

Durante la entrega **TB1**, el trabajo colaborativo del informe se expandió hacia los **Capítulos V y VI**, incorporando el diseño UI/UX de la solución, la arquitectura de navegación, wireframes, mock-ups, wireflows, prototipos y la documentación del **Sprint 1**. En paralelo, el equipo documentó la configuración inicial de repositorios, herramientas, convenciones de desarrollo, despliegue temprano de productos digitales y evidencias de ejecución del landing page y la web application.

La colaboración de esta entrega se enfocó en mantener consistencia entre los artefactos de experiencia de usuario y el alcance funcional definido en el backlog. El equipo trabajó sobre imágenes, prototipos, tablas de planificación y evidencias de sprint, asegurando que el informe reflejara tanto el diseño propuesto como la implementación inicial lograda. También se reforzó el uso de convenciones GitFlow y conventional commits para alinear la documentación con la evolución real del proyecto.

**Evidencia de colaboración TB1**

![Colaboración GitHub TB1](assets/reportedecolaboracion.jpeg)

### Entrega AV2

Durante la entrega **AV2**, el equipo actualizó el informe con la documentación del **Sprint 2**, la integración IoT end-to-end, la aplicación móvil, la capa edge, la sincronización en tiempo real, las entrevistas de validación y la evaluación heurística. Esta iteración exigió una mayor coordinación entre evidencias de código, despliegue, testing, validación con usuarios y resultados observados en la maqueta física.

En esta etapa, la elaboración del informe dejó de centrarse únicamente en propuestas de diseño y pasó a documentar evidencias verificables de implementación. El equipo registró pantallas reales, rutas, endpoints, flujos operativos, URLs desplegadas y resultados de validación con usuarios de ambos segmentos. La revisión colaborativa se concentró en comprobar que cada evidencia del Capítulo VI tuviera coherencia con las user stories activas, los sprint backlogs y los bounded contexts definidos previamente.

**Evidencia de colaboración AV2**

![Colaboración GitHub AV2](assets/reportedecolaboracion.jpeg)

### Entrega TF / TB2

Para la entrega **TF / TB2**, el equipo consolidó la versión final acumulativa del informe, corrigiendo secciones previas y alineando el contenido del backlog, sprint planning, student outcome, validación, despliegue y anexos con el alcance real del producto **ParkingNow**. En esta etapa se priorizó la consistencia transversal del documento completo, dejando trazabilidad entre el plan maestro del proyecto, las historias activas del MVP académico, los sprints ejecutados y las recomendaciones finales.

La colaboración del cierre se enfocó en depurar redundancias, corregir enlaces, actualizar conclusiones por entregable, mantener figuras y evidencias documentadas, y asegurar que el informe final represente correctamente el trabajo liderado por el Team Leader y respaldado por la participación de los demás integrantes. Esta consolidación final mantiene el historial de evolución del informe y evidencia que el trabajo fue iterativo, acumulativo y colaborativo durante todo el ciclo del proyecto.

**Evidencia de colaboración TF / TB2**

![Colaboración GitHub TF/TB2](assets/reportedecolaboracion.jpeg)
...
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta**                                | **Soto Quispe, Diego Ulises**<br>**AV1:** Lideró la consolidación de los Capítulos I, II, III y IV, alineando problema, entrevistas, backlog y arquitectura.<br>**TB1:** Dirigió la incorporación del Capítulo V y la documentación del Sprint 1 en el Capítulo VI, manteniendo coherencia con el enunciado del trabajo final.<br>**AV2:** Lideró la documentación del Sprint 2, la integración IoT end-to-end, las validaciones con usuarios y la evidencia de despliegue.<br>**TF/TB2:** Consolidó la versión final acumulativa del informe, corrigiendo backlog, student outcome, sprint evidence, conclusiones y anexos.<br><br>**Cuya Villegas, Rafael Alberto**<br>**AV1:** Revisó bounded contexts y diagramas C4 de contexto y contenedores.<br>**TB1:** Colaboró en landing page, evidencias visuales y criterios de despliegue inicial.<br>**AV2:** Apoyó en integración backend/edge y revisión de despliegues documentados.<br>**TF/TB2:** Participó en revisión de consistencia final entre evidencias técnicas y narrativa del informe.<br><br>**Lapa De La Cruz, Gabriel Omar**<br>**AV1:** Revisó diseño táctico y representación de componentes del Capítulo IV.<br>**TB1:** Apoyó en estructura base de frontend y su reflejo documental en sprint backlog y execution evidence.<br>**AV2:** Colaboró en frontend web, flujo de reservas y revisión de capturas funcionales del producto.<br>**TF/TB2:** Validó consistencia entre bounded contexts, user stories activas y secciones de implementación.<br><br>**Vásquez Villalobos, Elverth Jair**<br>**AV1:** Aportó revisión transversal de coherencia entre dominio, context mapping y arquitectura.<br>**TB1:** Colaboró en navegación inicial web y documentación de convenciones GitFlow.<br>**AV2:** Participó en evidencias de frontend web/mobile y revisión del flujo operacional visible en el sprint 2.<br>**TF/TB2:** Apoyó en la verificación integral de la narrativa técnica y la trazabilidad entre sprints y backlog.<br><br>**Vilca Valverde, Fiorella Angela**<br>**AV1:** Revisó consistencia entre entidades, relaciones y estructura documental.<br>**TB1:** Colaboró en revisión visual, responsive layout y consistencia UI/UX del Capítulo V.<br>**AV2:** Participó en mobile, validación con usuarios y revisión de heurísticas y evidencias de experiencia de usuario.<br>**TF/TB2:** Apoyó en la normalización final de presentación, imágenes, enlaces y consistencia visual del informe. | **AV1:** El liderazgo conjunto se expresó en la construcción de una base sólida de análisis, requisitos y arquitectura, con Diego como integrador principal y el resto del equipo como revisores especializados.<br><br>**TB1:** El liderazgo se distribuyó hacia diseño, frontend y documentación de sprint, permitiendo pasar del diseño conceptual a una primera base implementable y documentada.<br><br>**AV2:** El liderazgo conjunto se evidenció en la coordinación entre backend, frontend, mobile, edge e IoT, necesaria para documentar una solución ya integrada y validada con usuarios.<br><br>**TF/TB2:** En la entrega final, el liderazgo se consolidó en la depuración, corrección y cierre integral del informe, asegurando que la versión final represente el trabajo acumulativo del equipo durante todo el ciclo del proyecto. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **Soto Quispe, Diego Ulises**<br>**AV1:** Planificó el orden de construcción del informe y centralizó criterios de redacción y estructura.<br>**TB1:** Organizó la transición hacia sprint planning, UI/UX y despliegue temprano.<br>**AV2:** Coordinó la integración de pruebas, entrevistas, heurísticas y deployment evidence.<br>**TF/TB2:** Reordenó y consolidó los entregables finales en una sola versión coherente del informe.<br><br>**Cuya Villegas, Rafael Alberto**<br>**AV1:** Apoyó en revisión conceptual del diseño estratégico.<br>**TB1:** Colaboró en landing page y evidencia de implementación.<br>**AV2:** Apoyó en despliegue y revisión de servicios.<br>**TF/TB2:** Participó en validación de consistencia final.<br><br>**Lapa De La Cruz, Gabriel Omar**<br>**AV1:** Aportó revisión técnica de componentes.<br>**TB1:** Colaboró en estructura frontend y claridad técnica del sprint backlog.<br>**AV2:** Participó en vistas web y su documentación funcional.<br>**TF/TB2:** Validó alineamiento entre diseño táctico e implementación documentada.<br><br>**Vásquez Villalobos, Elverth Jair**<br>**AV1:** Colaboró en consistencia arquitectónica y de dominio.<br>**TB1:** Apoyó en navegación inicial y convenciones de trabajo.<br>**AV2:** Participó en evidencias de ejecución y revisión de flujos implementados.<br>**TF/TB2:** Apoyó en comprobación de trazabilidad entre backlog, sprint y evidencias.<br><br>**Vilca Valverde, Fiorella Angela**<br>**AV1:** Colaboró en formato y coherencia documental.<br>**TB1:** Apoyó en revisión visual y consistencia de UX.<br>**AV2:** Participó en validación con usuarios y revisión heurística.<br>**TF/TB2:** Contribuyó a la normalización final de imágenes, anexos y estructura visual del informe. | **AV1:** El equipo estableció una base común de trabajo, con reglas de organización, revisión y documentación que facilitaron una participación distribuida desde el inicio.<br><br>**TB1:** Las metas del sprint permitieron traducir el análisis previo en un primer conjunto de artefactos visuales y de implementación, manteniendo orden y responsabilidades compartidas.<br><br>**AV2:** La planificación colaborativa permitió cumplir objetivos más complejos, integrando productos, servicios, evidencia de validación y despliegues reales dentro del informe.<br><br>**TF/TB2:** El entorno colaborativo se mantuvo hasta el cierre del proyecto, permitiendo revisar, corregir y consolidar el informe final como un entregable completo, acumulativo y alineado con el trabajo ejecutado por el equipo. |
...
![User Persona del conductor urbano](assets/AndrésVillanuevaRíos1.png)
...
![User Persona del administrador independiente](assets/JorgeQuispeHuamánAdministradorIndependiente.png)
...
![User Journey Map As-Is del conductor urbano](assets/JourneyMapAndrésVillanueva(ConductorUrbano).png)
...
![User Journey Map As-Is del administrador independiente](assets/JourneyMapLuisRamírezTorres(AdministradorIndependiente).png)
...
![Empathy Map del conductor urbano](assets/EmpathyMapAndrésVillanuevaRíos(ConductorUrbano).png)
...
![Empathy Map del administrador independiente](assets/LuisRamírezTorresAdministradorIndependiente.png)
...
En esta sección se presenta el conjunto de **User Stories activas de ParkingNow**, corregidas y alineadas con el **PLAN_MAESTRO_PARKINGNOW.md**. El plan maestro define un backlog reducido de **60 historias activas** para el MVP académico, a partir de un backlog exploratorio inicial de **125 historias**. Por tanto, la presente sección replica únicamente las historias que sí forman parte del alcance real del trabajo final.

### Épicas del proyecto

| Epic ID | Título | Descripción |
| ------- | ------ | ----------- |
| EP01 | Landing Page / Visitante | Presentación pública del producto, propuesta de valor y captación de interés. |
| EP02 | Conductor - Descubrimiento y búsqueda | Búsqueda de estacionamientos, detalle y disponibilidad por espacio. |
| EP03 | Conductor - Reservas y ticket virtual | Reserva anticipada, confirmación, ticket y ciclo de vida de la reserva. |
| EP04 | Conductor - Historial y estado de reserva | Estado actual e historial de reservas del conductor. |
| EP05 | Dueño / Administrador - Registro de estacionamiento y espacios | Registro del parking lot, ubicación, espacios y vínculo con nodo IoT. |
| EP06 | Dueño / Administrador - Monitoreo operativo y eventos | Monitoreo de espacios, reservas, estado del nodo, eventos IoT y cámara. |
| EP07 | Web App - Autenticación y sesión | Registro, login y logout del owner panel. |
| EP08 | Mobile App - Autenticación y experiencia móvil | Registro, login, logout y persistencia de sesión del conductor. |
| EP09 | Technical Stories - Backend RESTful API | Core API para autenticación, parking lots, spaces y reservas. |
| EP10 | Technical Stories - IoT API / Eventos IoT | Ingesta de eventos, regla de precedencia y estado consolidado. |
| EP13 | Technical Stories - Cloud / Realtime / Sincronización | Realtime y último estado conocido. |
| EP14 | Technical Stories - Embedded / Firmware ESP32 | Lectura de sensores, debounce, heartbeat y señalización local. |
| EP16 | Technical Stories - Integraciones externas | Integración con OpenStreetMap. |
| EP17 | Technical Stories - Testing, Quality Assurance y Validación | Validación end-to-end del flujo principal. |
| EP19 | Maker Stories - Maqueta física y prototipo IoT | Construcción e instrumentación del prototipo físico. |

### Historias de usuario, técnicas y maker stories activas

| Story ID | Título | Descripción | Criterios de Aceptación | Relacionado con (Epic ID) |
| -------- | ------ | ----------- | ----------------------- | ------------------------- |
| US-LP.1 | Comprender propuesta de valor del servicio | Como Visitante, quiero entender rápidamente qué ofrece ParkingNow, para decidir si el servicio se ajusta a mis necesidades de estacionamiento. | Given el visitante ingresa a la landing page, when revisa la propuesta principal, then identifica problema, solución y segmentos objetivo. | EP01 |
| US-LP.2 | Conocer beneficios del servicio como conductor | Como Visitante interesado como conductor, quiero conocer beneficios específicos para mi perfil, para evaluar si vale la pena instalar la aplicación móvil. | Given el visitante revisa la sección para conductores, when compara beneficios, then identifica ahorro de tiempo y disponibilidad verificada. | EP01 |
| US-LP.3 | Conocer beneficios del servicio como administrador | Como Visitante interesado en afiliar su estacionamiento, quiero conocer beneficios para administradores, para evaluar si el servicio responde a mi operación. | Given el visitante revisa la sección para administradores, when lee la propuesta, then identifica monitoreo, reservas y visibilidad digital. | EP01 |
| US-LP.4 | Entender cómo funciona el servicio | Como Visitante, quiero comprender de manera sencilla cómo funciona el servicio, para reducir incertidumbre antes de decidir. | Given el visitante consulta la sección how-it-works, when revisa flujo general, then comprende relación entre landing, app móvil, panel web y nodo IoT. | EP01 |
| US-LP.5 | Percibir confianza y credibilidad del servicio | Como Visitante, quiero identificar señales de confianza sobre el servicio, para sentirme más seguro antes de compartir datos o afiliar mi negocio. | Given el visitante recorre la landing, when revisa equipo, startup y narrativa del producto, then percibe consistencia y credibilidad. | EP01 |
| US-LP.6 | Registrar interés mediante formulario de contacto | Como Visitante interesado, quiero dejar mis datos de contacto para recibir información adicional, para iniciar una posible relación con el servicio. | Given el visitante completa el formulario, when envía datos válidos, then sistema registra solicitud y confirma recepción. | EP01 |
| US-LP.7 | Conocer quién está detrás del servicio | Como Visitante, quiero saber quién desarrolla el servicio y con qué propósito, para valorar seriedad de la iniciativa antes de confiar en la plataforma. | Given el visitante consulta sección startup, when revisa información del equipo, then reconoce responsables y propósito del producto. | EP01 |
| US-LP.8 | Resolver dudas frecuentes antes de adoptar el servicio | Como Visitante, quiero acceder a respuestas claras sobre dudas comunes, para tomar una decisión informada sin solicitar contacto. | Given el visitante revisa FAQ, when busca dudas operativas, then encuentra respuestas sobre disponibilidad, reservas y afiliación. | EP01 |
| US-WEB.1 | Registrarse como administrador en el panel web | Como Administrador, quiero crear mi cuenta en el panel web, para acceder a las funcionalidades de gestión de mi estacionamiento. | Given el administrador completa formulario de registro, when envía datos válidos, then sistema crea cuenta owner. | EP07 |
| US-WEB.2 | Iniciar sesión en el panel web | Como Administrador, quiero autenticarme en el panel web con mis credenciales, para acceder a la información y funcionalidades asociadas a mi estacionamiento. | Given el owner posee credenciales válidas, when inicia sesión, then accede al dashboard. | EP07 |
| US-WEB.3 | Cerrar sesión de forma segura | Como Administrador, quiero cerrar mi sesión cuando lo decida, para evitar que otras personas accedan a mi información desde el mismo equipo. | Given el owner está autenticado, when selecciona logout, then token se elimina y sesión termina. | EP07 |
| US-OWN.1 | Registrar su estacionamiento en la plataforma | Como Administrador, quiero dar de alta mi estacionamiento dentro del servicio, para comenzar a gestionar mi operación desde el panel web. | Given el owner tiene cuenta, when registra un parking lot, then sistema crea estacionamiento asociado a su perfil. | EP05 |
| US-OWN.2 | Registrar la ubicación del estacionamiento | Como Administrador, quiero registrar la ubicación precisa de mi estacionamiento, para que los conductores puedan encontrarlo correctamente en la plataforma. | Given el owner edita perfil del estacionamiento, when guarda dirección y coordenadas, then ubicación queda disponible para consulta. | EP05 |
| US-OWN.3 | Registrar los espacios del estacionamiento | Como Administrador, quiero configurar los espacios disponibles de mi estacionamiento, para que el sistema los reconozca y pueda monitorearlos individualmente. | Given el estacionamiento fue creado, when el owner registra espacios, then sistema genera slots operativos. | EP05 |
| US-OWN.8 | Conocer el estado actual de cada espacio | Como Administrador, quiero conocer en qué estado se encuentra cada espacio de mi estacionamiento, para gestionar la operación sin depender de revisión presencial constante. | Given el owner abre panel, when consulta monitoreo, then visualiza FREE, RESERVED y OCCUPIED por espacio. | EP06 |
| TS-API.1 | Servicio de consulta de estacionamientos y espacios | Como Developer, quiero contar con un servicio que exponga información de estacionamientos y sus espacios, para que los clientes web y móvil puedan presentarla de manera uniforme. | Given un cliente consulta la API, when solicita parking lots y spaces, then recibe información consistente para renderizar vistas. | EP09 |
| TS-API.3 | Servicio de gestión de estacionamientos por el administrador | Como Developer, quiero contar con un servicio que permita al administrador gestionar su estacionamiento y sus espacios, para que las operaciones de alta y actualización se realicen de forma controlada. | Given el owner ejecuta operaciones sobre su estacionamiento, when API procesa solicitud, then cambios quedan persistidos. | EP09 |
| TS-API.4 | Servicio de autenticación de usuarios | Como Developer, quiero contar con un servicio de autenticación consistente, para que los clientes web y móvil verifiquen identidad bajo reglas uniformes. | Given un usuario válido hace sign-in, when API genera respuesta, then entrega JWT y rol correspondiente. | EP09 |
| US-MOB.1 | Registrarse como conductor en la app móvil | Como Conductor, quiero crear mi cuenta desde la aplicación móvil, para acceder a funcionalidades de búsqueda y reserva. | Given el conductor completa registro válido, when envía formulario, then sistema crea cuenta driver. | EP08 |
| US-MOB.2 | Iniciar sesión en la aplicación móvil | Como Conductor, quiero autenticarme rápidamente en la aplicación, para reservar un espacio con la menor fricción posible. | Given el conductor tiene credenciales válidas, when hace sign-in, then accede al mapa principal. | EP08 |
| US-MOB.3 | Cerrar sesión desde la aplicación móvil | Como Conductor, quiero cerrar mi sesión desde mi dispositivo, para evitar que terceros usen mi cuenta si comparto el equipo o lo pierdo. | Given el conductor está autenticado, when hace logout, then la sesión finaliza y vuelve al login. | EP08 |
| US-MOB.4 | Mantener su sesión activa entre usos normales | Como Conductor, quiero que mi sesión se conserve entre usos regulares de la aplicación, para no tener que autenticarme constantemente al abrir la app. | Given el conductor ya inició sesión, when vuelve a abrir la app, then sistema restaura su sesión activa. | EP08 |
| US-DRV.1 | Identificar estacionamientos cercanos a su ubicación | Como Conductor, quiero conocer estacionamientos disponibles cerca de donde estoy, para tomar una decisión rápida sin recorrer la zona buscando alternativas. | Given el conductor otorga permiso de ubicación, when abre mapa, then visualiza estacionamientos cercanos ordenados por proximidad. | EP02 |
| US-DRV.2 | Buscar estacionamientos cerca de un destino específico | Como Conductor, quiero buscar estacionamientos alrededor de un destino indicado, para planificar con anticipación dónde dejar mi vehículo antes de llegar. | Given el conductor ingresa un destino válido, when ejecuta la búsqueda, then sistema muestra opciones en zona objetivo. | EP02 |
| US-DRV.3 | Consultar información relevante de un estacionamiento | Como Conductor, quiero revisar datos principales de un estacionamiento, para decidir con mayor criterio si me conviene acercarme a ese lugar. | Given el conductor selecciona un estacionamiento, when abre detalle, then ve ubicación, disponibilidad general y condiciones principales. | EP02 |
| US-DRV.4 | Consultar disponibilidad por espacio en un estacionamiento afiliado | Como Conductor, quiero conocer cuántos espacios están disponibles en un estacionamiento afiliado, para decidir con confianza si me conviene desplazarme a ese lugar. | Given el conductor abre detalle de un estacionamiento afiliado, when revisa sus espacios, then visualiza estado por cada slot. | EP02 |
| US-DRV.5 | Distinguir estacionamientos con disponibilidad verificada | Como Conductor, quiero diferenciar los estacionamientos con disponibilidad verificada por IoT de los que son solo referencia, para priorizar opciones con mayor certeza. | Given el conductor revisa mapa y resultados, when compara estacionamientos, then distingue los afiliados con disponibilidad verificada. | EP02 |
| US-DRV.9 | Reservar un espacio disponible anticipadamente | Como Conductor, quiero reservar un espacio libre antes de llegar al estacionamiento, para asegurar mi llegada sin depender de la disponibilidad del momento. | Given existe un espacio libre, when el conductor confirma reserva, then sistema crea reserva activa asociada a espacio y usuario. | EP03 |
| US-DRV.10 | Recibir confirmación inmediata de la reserva | Como Conductor, quiero obtener una confirmación clara cuando mi reserva es aceptada, para tener certeza del compromiso del espacio antes de desplazarme. | Given la reserva fue creada, when backend responde exitosamente, then app muestra confirmación inmediata. | EP03 |
| US-DRV.11 | Obtener un ticket virtual de la reserva | Como Conductor, quiero contar con un ticket virtual asociado a mi reserva, para acreditar al llegar al estacionamiento que el espacio me fue asignado. | Given la reserva está activa, when el conductor abre TicketScreen, then visualiza identificador, estado, espacio y countdown. | EP03 |
| US-DRV.13 | Conocer el tiempo límite para consumir su reserva | Como Conductor, quiero saber hasta cuándo es válida mi reserva, para organizarme y llegar a tiempo sin perder el espacio comprometido. | Given el conductor tiene reserva activa, when revisa el ticket, then conoce tiempo restante hasta expirar. | EP03 |
| US-OWN.9 | Monitorear las reservas activas del estacionamiento | Como Administrador, quiero saber qué reservas están vigentes en mi local, para anticipar la llegada de conductores y ordenar la operación. | Given el owner abre módulo de reservas activas, when consulta lista, then visualiza reservas vigentes y tiempos asociados. | EP06 |
| US-OWN.10 | Consultar el historial de reservas del estacionamiento | Como Administrador, quiero revisar las reservas que han ocurrido en mi local, para tener trazabilidad del uso del servicio sin depender de registros manuales. | Given el owner consulta historial, when filtra o revisa registros, then visualiza reservas pasadas y sus estados finales. | EP06 |
| US-OWN.11 | Revisar eventos IoT generados por el nodo | Como Administrador, quiero acceder a los eventos generados por el nodo IoT, para contar con trazabilidad operativa de lo que ocurre con los espacios de mi local. | Given el owner abre el log de eventos, when consulta historial IoT, then sistema muestra cambios de estado y timestamps. | EP06 |
| US-OWN.12 | Conocer el estado de conexión del nodo IoT | Como Administrador, quiero saber si el nodo IoT de mi estacionamiento está reportando normalmente, para reaccionar oportunamente ante incidentes operativos. | Given el owner revisa estado del nodo, when sistema procesa heartbeats, then muestra online/offline y último latido. | EP06 |
| US-OWN.13 | Enterarse de cambios relevantes sin revisión manual permanente | Como Administrador, quiero enterarme de cambios importantes sin estar revisando el panel todo el tiempo, para reducir la carga operativa y reaccionar solo cuando sea necesario. | Given ocurren cambios en spaces o reservations, when Realtime propaga eventos, then panel owner se actualiza sin refresh manual. | EP06 |
| US-OWN.14 | Apoyar supervisión con una vista simple de cámara local | Como Administrador, quiero contar con una vista visual simple del estacionamiento, para complementar la información de ocupación cuando necesite confirmar lo que ocurre. | Given el owner abre módulo de cámara, when sistema recupera snapshot reciente, then visualiza evidencia visual del local. | EP06 |
| TS-IOT.1 | Ingesta de eventos IoT del nodo | Como Developer, quiero que la IoT API reciba de forma controlada los eventos enviados por el nodo físico, para reflejar de manera confiable los cambios detectados en los espacios. | Given el nodo envía un evento válido, when Edge/Core lo reciben, then actualizan estado del espacio relacionado. | EP10 |
| TS-IOT.4 | Aplicación de la regla de precedencia de estados | Como Developer, quiero aplicar la regla de precedencia que prioriza el estado físico sobre el lógico, para que el estado visible del espacio refleje coherentemente la realidad. | Given coexisten reserva y ocupación física, when backend consolida estado, then aplica regla de precedencia establecida. | EP10 |
| TS-IOT.6 | Estado consolidado del espacio | Como Developer, quiero exponer un estado consolidado del espacio, para que web y mobile consuman una sola representación final del espacio. | Given cambian estados internos del slot, when clientes consultan o reciben evento, then observan estado final consistente. | EP10 |
| TS-IOT.7 | Comportamiento ante desconexión del nodo | Como Developer, quiero definir el comportamiento del sistema cuando el nodo pierde conectividad, para que usuarios reciban información coherente en ese escenario. | Given el nodo deja de reportar, when vence umbral de heartbeat, then sistema conserva último estado conocido y marca nodo offline. | EP10 |
| TS-EMB.1 | Lectura periódica del estado del sensor | Como Developer, quiero que el firmware del ESP32 lea periódicamente el estado del sensor asociado a cada espacio, para detectar de forma confiable cambios de ocupación. | Given el firmware está corriendo, when se ejecuta loop, then sensores se leen en intervalo definido. | EP14 |
| TS-EMB.2 | Lógica local de estabilización del estado detectado | Como Developer, quiero que el firmware aplique una lógica de estabilización antes de considerar un cambio de estado, para reducir falsos positivos por lecturas transitorias. | Given ocurre una variación temporal del sensor, when debounce evalúa varias lecturas, then solo confirma cambios estables. | EP14 |
| TS-EMB.3 | Envío de eventos del nodo al backend | Como Developer, quiero que el nodo envíe eventos confiables al backend cuando detecte cambios relevantes, para mantener sincronizada la información del espacio. | Given el sensor confirma cambio de estado, when firmware genera payload, then evento es enviado a Edge/Core. | EP14 |
| TS-CLD.1 | Propagación en tiempo real a clientes | Como Developer, quiero que los cambios se propaguen en tiempo real a los clientes, para que las vistas operativas se actualicen sin refresh manual. | Given cambia un espacio o una reserva, when evento se persiste, then Angular y Flutter reciben actualización Realtime. | EP13 |
| US-DRV.14 | Expirar automáticamente la reserva si no se consume a tiempo | Como Conductor, quiero que el sistema libere el espacio si no llego dentro del tiempo acordado, para que el funcionamiento sea justo y el espacio pueda ofrecerse a otros conductores. | Given vence la vigencia de una reserva no consumida, when sistema ejecuta regla de expiración, then reserva pasa a EXPIRED y espacio vuelve a FREE. | EP03 |
| US-DRV.15 | Cancelar una reserva antes de utilizarla | Como Conductor, quiero cancelar mi reserva cuando mis planes cambien, para liberar el espacio a tiempo y no comprometerme innecesariamente. | Given la reserva sigue activa, when el conductor selecciona cancelar, then sistema libera espacio y actualiza estado a CANCELLED. | EP03 |
| US-DRV.16 | Reconocer que su reserva fue consumida al ocupar el espacio | Como Conductor, quiero saber que mi reserva se marcó como consumida cuando ocupo el espacio, para confirmar que mi llegada fue reconocida correctamente por el sistema. | Given el sensor detecta ocupación del espacio reservado, when backend consolida evento, then ticket cambia a CONSUMED. | EP03 |
| US-DRV.17 | Consultar el estado actualizado de su reserva | Como Conductor, quiero conocer el estado actual de mi reserva activa, para tener certeza durante mi trayecto de que el espacio continúa asignado a mí. | Given el conductor tiene una reserva, when consulta su estado, then sistema muestra estado actualizado correctamente. | EP04 |
| US-DRV.18 | Acceder al historial de reservas realizadas | Como Conductor, quiero revisar las reservas que he realizado previamente, para tener referencia de los estacionamientos que ya he utilizado. | Given el conductor consulta historial, when abre lista de reservas, then visualiza reservas pasadas con su estado final. | EP04 |
| US-DRV.20 | Identificar rápidamente sus reservas activas | Como Conductor, quiero reconocer cuáles de mis reservas están activas, para saber si actualmente tengo un espacio comprometido sin revisar cada registro. | Given el conductor tiene reservas en distintos estados, when abre historial, then sistema resalta o separa reservas activas. | EP04 |
| US-OWN.7 | Asociar el nodo IoT a su estacionamiento | Como Administrador, quiero vincular el nodo IoT físico a mi estacionamiento, para que los eventos detectados por sus sensores se reflejen correctamente en los espacios. | Given el estacionamiento ya existe, when el owner vincula nodeId, then los eventos del nodo quedan asociados al parking lot. | EP05 |
| TS-API.2 | Servicio de gestión de reservas | Como Developer, quiero disponer de un servicio que gestione el ciclo de vida de las reservas, para mantener integridad operativa entre app móvil, panel web e información IoT. | Given una reserva se crea, cancela, expira o consume, when backend procesa evento o comando, then preserva consistencia del ciclo de vida. | EP09 |
| TS-CLD.5 | Último estado conocido del espacio | Como Developer, quiero conservar y exponer el último estado conocido, para evitar pérdida de contexto operativo durante una caída temporal del nodo. | Given el nodo está offline, when cliente consulta estado, then sistema devuelve último estado conocido con advertencia operacional. | EP13 |
| TS-EXT.1 | Integración con OpenStreetMap como referencia | Como Developer, quiero integrar información de OpenStreetMap para poblar el mapa inicial, para ofrecer utilidad al conductor desde el primer uso. | Given el conductor abre mapa, when app consulta tiles y referencias OSM, then visualiza contexto geográfico útil. | EP16 |
| TS-EMB.4 | Emisión de heartbeat del nodo | Como Developer, quiero que el nodo emita heartbeat periódico al backend, para permitir detectar oportunamente pérdidas de conexión del dispositivo. | Given el nodo permanece online, when vence intervalo de heartbeat, then envía latido al backend. | EP14 |
| TS-EMB.5 | Actuación local mediante indicadores visuales | Como Developer, quiero que el nodo active indicadores físicos locales alineados con el estado del espacio, para ofrecer referencia operativa visible dentro del estacionamiento. | Given cambia estado del espacio, when firmware actualiza LEDs, then indicadores físicos reflejan condición del slot. | EP14 |
| MS-01 | Construir la maqueta física del estacionamiento | Como Maker, quiero construir una maqueta física con espacios de estacionamiento definidos, para representar de forma tangible el escenario de validación del prototipo IoT. | Given se dispone de materiales, when se construye la maqueta, then el prototipo representa al menos dos espacios monitoreados. | EP19 |
| MS-02 | Instalar sensores ultrasónicos en la maqueta | Como Maker, quiero instalar sensores ultrasónicos en los espacios de la maqueta, para detectar físicamente la ocupación de cada espacio durante la demostración. | Given la maqueta fue construida, when se instalan sensores y se prueba un vehículo, then la lectura física responde al cambio observado. | EP19 |
| TS-TST.7 | Validación end-to-end del flujo principal | Como Developer, quiero validar de extremo a extremo el flujo central del sistema, para asegurar coherencia en la experiencia completa del conductor. | Given solución integrada, when se ejecuta escenario búsqueda-reserva-consumo, then web y mobile reflejan resultados correctos. | EP17 |


### Historias fuera de alcance de la versión v1

Según el plan maestro, el backlog exploratorio original de **125 historias** fue reducido a **60 historias activas**. Las historias removidas de la versión v1 fueron declaradas fuera de alcance por no ser críticas para el MVP académico o por exceder la capacidad real de ejecución del proyecto en el ciclo.
## 3.2. Impact Mapping
...
![Impact Mapping del segmento administrador de estacionamiento independiente de ParkingNow](assets/impactdueño.png)
...
En esta sección se presenta el **Product Backlog** de **ParkingNow** con el **formato de tabla de la plantilla del trabajo final**, pero corregido para reflejar solo las **60 historias activas** definidas en el plan maestro. La priorización sigue valor de negocio, dependencia técnica y secuencia de implementación real del proyecto.

**A. URL del Product Backlog**  
**Enlace público:** [ParkingNow Backlog en Jira](https://parkingnow-backlog.atlassian.net/jira/software/projects/SCRUM/boards/1/backlog?atlOrigin=eyJpIjoiNTM4MTcxOWQyZmY0NDZiNzhiNDlmNzBmMzkyZDMxYjAiLCJwIjoiaiJ9)
...
| ------- | ------------- | ------ | ----------- | -------------------------------- |
| 1 | US-LP.1 | Comprender propuesta de valor del servicio | Como Visitante, quiero entender rápidamente qué ofrece ParkingNow, para decidir si el servicio se ajusta a mis necesidades de estacionamiento. | 2 |
| 2 | US-LP.2 | Conocer beneficios del servicio como conductor | Como Visitante interesado como conductor, quiero conocer beneficios específicos para mi perfil, para evaluar si vale la pena instalar la aplicación móvil. | 2 |
| 3 | US-LP.3 | Conocer beneficios del servicio como administrador | Como Visitante interesado en afiliar su estacionamiento, quiero conocer beneficios para administradores, para evaluar si el servicio responde a mi operación. | 2 |
| 4 | US-LP.4 | Entender cómo funciona el servicio | Como Visitante, quiero comprender de manera sencilla cómo funciona el servicio, para reducir incertidumbre antes de decidir. | 3 |
...
| 7 | US-LP.7 | Conocer quién está detrás del servicio | Como Visitante, quiero saber quién desarrolla el servicio y con qué propósito, para valorar seriedad de la iniciativa antes de confiar en la plataforma. | 1 |
| 8 | US-LP.8 | Resolver dudas frecuentes antes de adoptar el servicio | Como Visitante, quiero acceder a respuestas claras sobre dudas comunes, para tomar una decisión informada sin solicitar contacto. | 2 |
| 9 | US-WEB.1 | Registrarse como administrador en el panel web | Como Administrador, quiero crear mi cuenta en el panel web, para acceder a las funcionalidades de gestión de mi estacionamiento. | 3 |
| 10 | US-WEB.2 | Iniciar sesión en el panel web | Como Administrador, quiero autenticarme en el panel web con mis credenciales, para acceder a la información y funcionalidades asociadas a mi estacionamiento. | 2 |
| 11 | US-WEB.3 | Cerrar sesión de forma segura | Como Administrador, quiero cerrar mi sesión cuando lo decida, para evitar que otras personas accedan a mi información desde el mismo equipo. | 1 |
| 12 | US-OWN.1 | Registrar su estacionamiento en la plataforma | Como Administrador, quiero dar de alta mi estacionamiento dentro del servicio, para comenzar a gestionar mi operación desde el panel web. | 3 |
| 13 | US-OWN.2 | Registrar la ubicación del estacionamiento | Como Administrador, quiero registrar la ubicación precisa de mi estacionamiento, para que los conductores puedan encontrarlo correctamente en la plataforma. | 2 |
| 14 | US-OWN.3 | Registrar los espacios del estacionamiento | Como Administrador, quiero configurar los espacios disponibles de mi estacionamiento, para que el sistema los reconozca y pueda monitorearlos individualmente. | 3 |
| 15 | US-OWN.8 | Conocer el estado actual de cada espacio | Como Administrador, quiero conocer en qué estado se encuentra cada espacio de mi estacionamiento, para gestionar la operación sin depender de revisión presencial constante. | 3 |
| 16 | TS-API.1 | Servicio de consulta de estacionamientos y espacios | Como Developer, quiero contar con un servicio que exponga información de estacionamientos y sus espacios, para que los clientes web y móvil puedan presentarla de manera uniforme. | 5 |
| 17 | TS-API.3 | Servicio de gestión de estacionamientos por el administrador | Como Developer, quiero contar con un servicio que permita al administrador gestionar su estacionamiento y sus espacios, para que las operaciones de alta y actualización se realicen de forma controlada. | 5 |
| 18 | TS-API.4 | Servicio de autenticación de usuarios | Como Developer, quiero contar con un servicio de autenticación consistente, para que los clientes web y móvil verifiquen identidad bajo reglas uniformes. | 3 |
| 19 | US-MOB.1 | Registrarse como conductor en la app móvil | Como Conductor, quiero crear mi cuenta desde la aplicación móvil, para acceder a funcionalidades de búsqueda y reserva. | 3 |
| 20 | US-MOB.2 | Iniciar sesión en la aplicación móvil | Como Conductor, quiero autenticarme rápidamente en la aplicación, para reservar un espacio con la menor fricción posible. | 2 |
| 21 | US-MOB.3 | Cerrar sesión desde la aplicación móvil | Como Conductor, quiero cerrar mi sesión desde mi dispositivo, para evitar que terceros usen mi cuenta si comparto el equipo o lo pierdo. | 1 |
| 22 | US-MOB.4 | Mantener su sesión activa entre usos normales | Como Conductor, quiero que mi sesión se conserve entre usos regulares de la aplicación, para no tener que autenticarme constantemente al abrir la app. | 2 |
| 23 | US-DRV.1 | Identificar estacionamientos cercanos a su ubicación | Como Conductor, quiero conocer estacionamientos disponibles cerca de donde estoy, para tomar una decisión rápida sin recorrer la zona buscando alternativas. | 5 |
| 24 | US-DRV.2 | Buscar estacionamientos cerca de un destino específico | Como Conductor, quiero buscar estacionamientos alrededor de un destino indicado, para planificar con anticipación dónde dejar mi vehículo antes de llegar. | 5 |
| 25 | US-DRV.3 | Consultar información relevante de un estacionamiento | Como Conductor, quiero revisar datos principales de un estacionamiento, para decidir con mayor criterio si me conviene acercarme a ese lugar. | 2 |
| 26 | US-DRV.4 | Consultar disponibilidad por espacio en un estacionamiento afiliado | Como Conductor, quiero conocer cuántos espacios están disponibles en un estacionamiento afiliado, para decidir con confianza si me conviene desplazarme a ese lugar. | 3 |
| 27 | US-DRV.5 | Distinguir estacionamientos con disponibilidad verificada | Como Conductor, quiero diferenciar los estacionamientos con disponibilidad verificada por IoT de los que son solo referencia, para priorizar opciones con mayor certeza. | 3 |
| 28 | US-DRV.9 | Reservar un espacio disponible anticipadamente | Como Conductor, quiero reservar un espacio libre antes de llegar al estacionamiento, para asegurar mi llegada sin depender de la disponibilidad del momento. | 5 |
| 29 | US-DRV.10 | Recibir confirmación inmediata de la reserva | Como Conductor, quiero obtener una confirmación clara cuando mi reserva es aceptada, para tener certeza del compromiso del espacio antes de desplazarme. | 3 |
| 30 | US-DRV.11 | Obtener un ticket virtual de la reserva | Como Conductor, quiero contar con un ticket virtual asociado a mi reserva, para acreditar al llegar al estacionamiento que el espacio me fue asignado. | 3 |
| 31 | US-DRV.13 | Conocer el tiempo límite para consumir su reserva | Como Conductor, quiero saber hasta cuándo es válida mi reserva, para organizarme y llegar a tiempo sin perder el espacio comprometido. | 2 |
| 32 | US-OWN.9 | Monitorear las reservas activas del estacionamiento | Como Administrador, quiero saber qué reservas están vigentes en mi local, para anticipar la llegada de conductores y ordenar la operación. | 3 |
| 33 | US-OWN.10 | Consultar el historial de reservas del estacionamiento | Como Administrador, quiero revisar las reservas que han ocurrido en mi local, para tener trazabilidad del uso del servicio sin depender de registros manuales. | 2 |
| 34 | US-OWN.11 | Revisar eventos IoT generados por el nodo | Como Administrador, quiero acceder a los eventos generados por el nodo IoT, para contar con trazabilidad operativa de lo que ocurre con los espacios de mi local. | 3 |
| 35 | US-OWN.12 | Conocer el estado de conexión del nodo IoT | Como Administrador, quiero saber si el nodo IoT de mi estacionamiento está reportando normalmente, para reaccionar oportunamente ante incidentes operativos. | 2 |
| 36 | US-OWN.13 | Enterarse de cambios relevantes sin revisión manual permanente | Como Administrador, quiero enterarme de cambios importantes sin estar revisando el panel todo el tiempo, para reducir la carga operativa y reaccionar solo cuando sea necesario. | 3 |
| 37 | US-OWN.14 | Apoyar supervisión con una vista simple de cámara local | Como Administrador, quiero contar con una vista visual simple del estacionamiento, para complementar la información de ocupación cuando necesite confirmar lo que ocurre. | 5 |
| 38 | TS-IOT.1 | Ingesta de eventos IoT del nodo | Como Developer, quiero que la IoT API reciba de forma controlada los eventos enviados por el nodo físico, para reflejar de manera confiable los cambios detectados en los espacios. | 5 |
| 39 | TS-IOT.4 | Aplicación de la regla de precedencia de estados | Como Developer, quiero aplicar la regla de precedencia que prioriza el estado físico sobre el lógico, para que el estado visible del espacio refleje coherentemente la realidad. | 5 |
| 40 | TS-IOT.6 | Estado consolidado del espacio | Como Developer, quiero exponer un estado consolidado del espacio, para que web y mobile consuman una sola representación final del espacio. | 5 |
| 41 | TS-IOT.7 | Comportamiento ante desconexión del nodo | Como Developer, quiero definir el comportamiento del sistema cuando el nodo pierde conectividad, para que usuarios reciban información coherente en ese escenario. | 3 |
| 42 | TS-EMB.1 | Lectura periódica del estado del sensor | Como Developer, quiero que el firmware del ESP32 lea periódicamente el estado del sensor asociado a cada espacio, para detectar de forma confiable cambios de ocupación. | 3 |
| 43 | TS-EMB.2 | Lógica local de estabilización del estado detectado | Como Developer, quiero que el firmware aplique una lógica de estabilización antes de considerar un cambio de estado, para reducir falsos positivos por lecturas transitorias. | 5 |
| 44 | TS-EMB.3 | Envío de eventos del nodo al backend | Como Developer, quiero que el nodo envíe eventos confiables al backend cuando detecte cambios relevantes, para mantener sincronizada la información del espacio. | 5 |
| 45 | TS-CLD.1 | Propagación en tiempo real a clientes | Como Developer, quiero que los cambios se propaguen en tiempo real a los clientes, para que las vistas operativas se actualicen sin refresh manual. | 5 |
| 46 | US-DRV.14 | Expirar automáticamente la reserva si no se consume a tiempo | Como Conductor, quiero que el sistema libere el espacio si no llego dentro del tiempo acordado, para que el funcionamiento sea justo y el espacio pueda ofrecerse a otros conductores. | 5 |
| 47 | US-DRV.15 | Cancelar una reserva antes de utilizarla | Como Conductor, quiero cancelar mi reserva cuando mis planes cambien, para liberar el espacio a tiempo y no comprometerme innecesariamente. | 3 |
| 48 | US-DRV.16 | Reconocer que su reserva fue consumida al ocupar el espacio | Como Conductor, quiero saber que mi reserva se marcó como consumida cuando ocupo el espacio, para confirmar que mi llegada fue reconocida correctamente por el sistema. | 3 |
| 49 | US-DRV.17 | Consultar el estado actualizado de su reserva | Como Conductor, quiero conocer el estado actual de mi reserva activa, para tener certeza durante mi trayecto de que el espacio continúa asignado a mí. | 3 |
| 50 | US-DRV.18 | Acceder al historial de reservas realizadas | Como Conductor, quiero revisar las reservas que he realizado previamente, para tener referencia de los estacionamientos que ya he utilizado. | 2 |
| 51 | US-DRV.20 | Identificar rápidamente sus reservas activas | Como Conductor, quiero reconocer cuáles de mis reservas están activas, para saber si actualmente tengo un espacio comprometido sin revisar cada registro. | 2 |
| 52 | US-OWN.7 | Asociar el nodo IoT a su estacionamiento | Como Administrador, quiero vincular el nodo IoT físico a mi estacionamiento, para que los eventos detectados por sus sensores se reflejen correctamente en los espacios. | 3 |
| 53 | TS-API.2 | Servicio de gestión de reservas | Como Developer, quiero disponer de un servicio que gestione el ciclo de vida de las reservas, para mantener integridad operativa entre app móvil, panel web e información IoT. | 8 |
| 54 | TS-CLD.5 | Último estado conocido del espacio | Como Developer, quiero conservar y exponer el último estado conocido, para evitar pérdida de contexto operativo durante una caída temporal del nodo. | 3 |
| 55 | TS-EXT.1 | Integración con OpenStreetMap como referencia | Como Developer, quiero integrar información de OpenStreetMap para poblar el mapa inicial, para ofrecer utilidad al conductor desde el primer uso. | 3 |
| 56 | TS-EMB.4 | Emisión de heartbeat del nodo | Como Developer, quiero que el nodo emita heartbeat periódico al backend, para permitir detectar oportunamente pérdidas de conexión del dispositivo. | 2 |
| 57 | TS-EMB.5 | Actuación local mediante indicadores visuales | Como Developer, quiero que el nodo active indicadores físicos locales alineados con el estado del espacio, para ofrecer referencia operativa visible dentro del estacionamiento. | 2 |
| 58 | MS-01 | Construir la maqueta física del estacionamiento | Como Maker, quiero construir una maqueta física con espacios de estacionamiento definidos, para representar de forma tangible el escenario de validación del prototipo IoT. | 3 |
...
![Application Layer Diagram Reservation](assets/Application Layer.png)
...
![Infrastructure Layer Diagram Reservation](assets/Infrastructure Layer Reservation.png)
...
![alt text](assets/Reservation Class Diagram.png)  
_Nota._ Elaboración propia (2026).
...
![alt text](assets/database diagram reservation.png)  
_Nota._ Elaboración propia (2026).
...
| --- | --- |
| Fecha | 2026-05-13 |
| Modalidad | Reunión virtual mediante Google Meet / Discord |
...
| Entrega asociada | TB1 |
| Sprint Goal | Our focus is on establishing the foundation of ParkingNow's digital presence and admin core. We believe it delivers visibility to parking owners and a functional admin panel to our admin segment. This will be confirmed when the Landing Page is deployed and an admin can register, login, and view their parking lot's spaces. |
| Sprint Velocity | 47 Story Points |
| Historias comprometidas | `US-LP.1` a `US-LP.8`, `US-WEB.1`, `US-WEB.2`, `US-WEB.3`, `US-OWN.1`, `US-OWN.2`, `US-OWN.3`, `US-OWN.8`, `TS-API.1`, `TS-API.3`, `TS-API.4` |

#### 6.2.1.2. Aspect Leaders and Collaborators.

| Aspecto | Leader | Collaborators | Responsabilidad principal |
| --- | --- | --- | --- |
| Project Report | Soto Quispe, Diego Ulises | Todo el equipo | Consolidar Capítulo V y Sprint 1 del Capítulo VI. |
| Landing Page | Cuya Villegas, Rafael Alberto | Vilca Valverde, Fiorella Angela | Implementación visual y call-to-action por segmento. |
| Web Application | Lapa De La Cruz, Gabriel Omar | Vásquez Villalobos, Elverth Jair | Estructura base del frontend y navegación inicial. |
| UX/UI Review | Vilca Valverde, Fiorella Angela | Soto Quispe, Diego Ulises | Validación visual contra wireframes y mock-ups. |
| Architecture Review | Vásquez Villalobos, Elverth Jair | Cuya Villegas, Rafael Alberto | Revisión de coherencia entre alcance, arquitectura y backlog. |
| Deployment | Soto Quispe, Diego Ulises | Cuya Villegas, Rafael Alberto | Preparación de despliegue inicial de landing, web y core API. |

#### 6.2.1.3. Sprint Backlog 1.

| Story ID | Título | SP | Entregable |
| --- | --- | --- | --- |
| `US-LP.1` | Comprender propuesta de valor | 2 | Hero principal y mensaje central |
| `US-LP.2` | Beneficios para conductores | 2 | Sección segmento conductor |
| `US-LP.3` | Beneficios para administradores | 2 | Sección segmento administrador |
| `US-LP.4` | Entender cómo funciona | 3 | Sección how-it-works |
| `US-LP.5` | Percibir confianza | 2 | Sección credibilidad / startup |
| `US-LP.6` | Formulario de contacto | 3 | Contact form y CTA |
| `US-LP.7` | Conocer equipo y startup | 1 | Sección team/startup |
| `US-LP.8` | Resolver dudas frecuentes | 2 | FAQ |
| `US-WEB.1` | Registro de administrador | 3 | Vista register |
| `US-WEB.2` | Login de administrador | 2 | Vista login |
| `US-WEB.3` | Logout seguro web | 1 | Cierre de sesión |
| `US-OWN.1` | Registrar estacionamiento | 3 | Formulario base parking lot |
| `US-OWN.2` | Registrar ubicación | 2 | Campo dirección / georreferencia |
| `US-OWN.3` | Registrar espacios | 3 | Configuración inicial de spaces |
| `US-OWN.8` | Ver estado de espacios | 3 | Vista operativa inicial |
| `TS-API.1` | Consulta de estacionamientos | 5 | Endpoints de consulta base |
| `TS-API.3` | Gestión de estacionamientos | 5 | CRUD base owner/parking |
| `TS-API.4` | Autenticación | 3 | Sign-up / sign-in / JWT |

##### 6.2.1.4. Development Evidence for Sprint Review.

Durante Sprint 1 el equipo construyó la base pública y administrativa de ParkingNow. El incremento se concentró en tres frentes: **Landing Page**, **Web Application del owner** y **Core API inicial**. La meta de esta iteración fue contar con una primera presencia digital desplegable, un flujo de autenticación funcional y una configuración inicial del estacionamiento que sirviera como base para el resto del producto.

| Repositorio | Evidencia principal | Resultado |
| --- | --- | --- |
| `Landing-Page-main` | Hero, beneficios por segmento, CTA, FAQ, sección startup | Primera versión pública del producto |
| `Web` | Login, registro, rutas base, estructura owner panel | Base navegable del panel administrativo |
| `back` | Autenticación, parking lots, spaces iniciales | Primera capa de servicios REST |
| `Report-main 3` | Capítulo V y Sprint 1 documentados | Trazabilidad entre diseño e implementación |

##### 6.2.1.5. Testing Suite Evidence for Sprint Review.

| Tipo de prueba | Producto | Evidencia validada | Estado |
| --- | --- | --- | --- |
| Manual UI Test | Landing Page | Hero, segmentos, CTA y FAQ visibles | OK |
| Manual Responsive Test | Landing Page | Visualización en desktop y mobile | OK |
| Manual Auth Test | Web App | Registro y login owner | OK |
| Manual Navigation Test | Web App | Rutas iniciales del panel | OK |
| API Smoke Test | Core API | Respuesta de endpoints de auth y parking base | OK |
| Documentation Review | Report | Coherencia entre Capítulo V y Sprint 1 | OK |
...
**Nomenclatura:** `upc-pre-202610-1asi0572-6770-codemondoguito-product-navigation-sprint-1.mp4`

##### 6.2.1.7. Services Documentation Evidence for Sprint Review.

| API / Service | Endpoint base | Acción cubierta en Sprint 1 | Estado |
| --- | --- | --- | --- |
...
| Integrante | Contribución principal Sprint 1 |
| --- | --- |
| Soto Quispe, Diego Ulises | Liderazgo del sprint, documentación del informe, despliegue inicial y consolidación del owner flow. |
| Cuya Villegas, Rafael Alberto | Desarrollo y revisión del Landing Page y apoyo en despliegue. |
| Lapa De La Cruz, Gabriel Omar | Estructura base de la Web Application y apoyo técnico al frontend. |
| Vásquez Villalobos, Elverth Jair | Navegación inicial, revisión de arquitectura y consistencia entre backlog y solución. |
| Vilca Valverde, Fiorella Angela | Revisión UX/UI, responsive behavior y apoyo visual del landing y panel. |

Durante esta iteración el equipo logró traducir el análisis y diseño previos en un incremento visible y desplegable. Sprint 1 dejó lista la base pública del producto, la primera experiencia del owner y la estructura técnica sobre la cual se montó la integración IoT posterior.
...
| Prepared by | Soto Quispe, Diego Ulises |
| Attendees | Cuya Villegas, Rafael Alberto / Soto Quispe, Diego Ulises / Lapa De La Cruz, Gabriel Omar / Vásquez Villalobos, Elverth Jair / Vilca Valverde, Fiorella Angela |
| Entrega asociada | AV2 |
| Sprint Goal | Our focus is on connecting the physical parking node with the driver's mobile experience. We believe it delivers real-time parking awareness to drivers and operational control to owners. This will be confirmed when an ESP32 sensor event updates the space status visible in both the Angular dashboard and Flutter app without manual refresh, and a driver can successfully reserve a space. |
| Sprint Velocity | 101 Story Points |
| Historias comprometidas | `US-MOB.1`, `US-MOB.2`, `US-MOB.3`, `US-MOB.4`, `US-DRV.1`, `US-DRV.2`, `US-DRV.3`, `US-DRV.4`, `US-DRV.5`, `US-DRV.9`, `US-DRV.10`, `US-DRV.11`, `US-DRV.13`, `US-OWN.9`, `US-OWN.10`, `US-OWN.11`, `US-OWN.12`, `US-OWN.13`, `US-OWN.14`, `TS-API.2`, `TS-IOT.1`, `TS-IOT.4`, `TS-IOT.6`, `TS-IOT.7`, `TS-EMB.1`, `TS-EMB.2`, `TS-EMB.3`, `TS-CLD.1` |

#### 6.2.2.2. Aspect Leaders and Collaborators.

| Aspecto | Leader | Collaborators | Responsabilidad principal |
| --- | --- | --- | --- |
| Backend + Core API | Soto Quispe, Diego Ulises | Cuya Villegas, Rafael Alberto | Reservas, spaces, dashboard, camera, auth y documentación técnica. |
| Edge API + IoT Integration | Cuya Villegas, Rafael Alberto | Soto Quispe, Diego Ulises | Recepción de eventos, heartbeat, snapshots y buffer operacional. |
| Web Application | Lapa De La Cruz, Gabriel Omar | Vásquez Villalobos, Elverth Jair | Dashboard, monitoreo, reservas, eventos y cámara del owner panel. |
| Mobile Application | Vilca Valverde, Fiorella Angela | Vásquez Villalobos, Elverth Jair | Registro/login driver, mapa, detalle, reserva y ticket. |
| Embedded / Firmware | Soto Quispe, Diego Ulises | Lapa De La Cruz, Gabriel Omar | Lectura de sensores, debounce, envío de eventos, heartbeat y LED indicators. |
| Validation & UX Review | Vilca Valverde, Fiorella Angela | Todo el equipo | Entrevistas, observaciones heurísticas y revisión de flujos reales. |

#### 6.2.2.3. Sprint Backlog 2.

| Story ID | Título | SP | Entregable |
| --- | --- | --- | --- |
| `US-MOB.1` | Registro de conductor | 3 | RegisterScreen |
| `US-MOB.2` | Login móvil | 2 | LoginScreen |
| `US-MOB.3` | Logout móvil | 1 | Settings / sign out |
| `US-MOB.4` | Persistencia de sesión | 2 | Auto-login con token |
| `US-DRV.1` | Ver estacionamientos cercanos | 5 | MapScreen |
| `US-DRV.2` | Buscar por destino | 5 | Search / destination flow |
| `US-DRV.3` | Ver información relevante | 2 | Parking detail |
| `US-DRV.4` | Ver disponibilidad por espacio | 3 | Space chips y estado por slot |
| `US-DRV.5` | Distinguir disponibilidad verificada | 3 | Diferenciación afiliado / verificado |
| `US-DRV.9` | Reservar anticipadamente | 5 | Reserva desde mobile |
| `US-DRV.10` | Confirmación inmediata | 3 | Confirmación post-reserva |
| `US-DRV.11` | Ticket virtual | 3 | TicketScreen |
| `US-DRV.13` | Tiempo límite de reserva | 2 | Countdown de 15 minutos |
| `US-OWN.9` | Monitorear reservas activas | 3 | Vista active reservations |
| `US-OWN.10` | Historial de reservas | 2 | Vista history |
| `US-OWN.11` | Revisar eventos IoT | 3 | Events log |
| `US-OWN.12` | Ver estado del nodo | 2 | Node status |
| `US-OWN.13` | Actualización automática | 3 | Supabase Realtime |
| `US-OWN.14` | Vista cámara local | 5 | Camera monitor |
| `TS-API.2` | Gestión de reservas | 8 | Reservation lifecycle API |
| `TS-IOT.1` | Ingesta de eventos IoT | 5 | POST IoT events |
| `TS-IOT.4` | Regla de precedencia | 5 | Consolidación físico/lógico |
| `TS-IOT.6` | Estado consolidado | 5 | Estado final propagado a clientes |
| `TS-IOT.7` | Manejo de desconexión | 3 | Last known state + offline node |
| `TS-EMB.1` | Lectura periódica sensor | 3 | Loop de lectura |
| `TS-EMB.2` | Debounce del sensor | 5 | Estabilización de lecturas |
| `TS-EMB.3` | Envío de eventos | 5 | POST edge events |
| `TS-CLD.1` | Propagación realtime | 5 | Broadcast a Angular y Flutter |

##### 6.2.2.4. Development Evidence for Sprint Review.

Durante Sprint 2 se desarrolló el incremento técnico más importante del proyecto: la **integración IoT end-to-end** entre el nodo físico, la capa edge, el Core API, la persistencia en Supabase, la actualización en tiempo real del panel web y la experiencia móvil del conductor. El sprint también incorporó la aplicación Flutter, la reserva anticipada, el ticket virtual, el monitoreo de eventos y la vista de cámara local.

| Repositorio | Evidencia principal | Resultado |
| --- | --- | --- |
| `Mobile/parkingnow_flutter` | Login, mapa, detalle, reserva y ticket | App del conductor funcional |
| `Web` | Dashboard, parking lot, reservations, camera, events | Panel web owner funcional |
| `back` | 36 endpoints documentados y operativos | Core API integrado |
| `Edge` | Recepción de eventos, heartbeat, snapshots, status | Capa edge operativa |
| `Embebido` | Lectura de sensores, debounce, heartbeat y envío de eventos | Nodo IoT funcional |
| `Report-main 3` | Sprint 2, validación y heurísticas | Evidencia acumulativa del incremento |

##### 6.2.2.5. Testing Suite Evidence for Sprint Review.

| Tipo de prueba | Evidencia | Cobertura |
| --- | --- | --- |
| Smoke Test | `ParkingNowApplicationTest` | Carga de contexto Spring Boot |
| Manual Integration Test | Mobile -> Core API -> Reservation | Registro, login, reserva y ticket |
| Manual Integration Test | ESP32 -> Edge -> Core -> Realtime | Cambio de estado del espacio |
| Manual UI Test | Owner dashboard | Espacios, eventos, nodo, cámara |
| Manual UI Test | Driver app | Mapa, detalle, reserva, ticket |
| Acceptance Test Draft | Flujo de reserva / expiración / consumo | Base para Sprint 3 |

**Estado real verificado:** en el backend existe un smoke test automatizado y la mayor parte de la verificación del sprint se ejecutó de forma funcional e integrada, priorizando el flujo IoT end-to-end y la demostración del producto operativo.
...
| Integrante | Roles principales Sprint 2 |
| --- | --- |
| Soto Quispe, Diego Ulises | Backend, firmware, integración IoT, testing, documentación final del sprint |
| Cuya Villegas, Rafael Alberto | Backend, edge, despliegue y revisión técnica |
| Lapa De La Cruz, Gabriel Omar | Frontend web y apoyo en embedded / validación visual |
| Vásquez Villalobos, Elverth Jair | Frontend web y soporte mobile / consistencia funcional |
| Vilca Valverde, Fiorella Angela | Mobile, validación con usuarios, revisión heurística y UX |
